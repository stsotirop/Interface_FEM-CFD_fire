...
from computation_core.cross_sections import create_cruciform


form, base = uic.loadUiType(resolve_path("section_properties_ui/Cruciform.ui"))


class AddCruciformUi(base, form):
    ...
    def clicker_create_profile(self):
        ...
        exist_flag = create_cruciform(h, b, tw, tfl, self.pathFolder, profile_name)
        if exist_flag:
            msg = QMessageBox()
