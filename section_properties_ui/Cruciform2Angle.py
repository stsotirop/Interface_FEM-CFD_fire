...
from computation_core.cross_sections import create_2l_cruciform


form, base = uic.loadUiType(resolve_path("section_properties_ui/Cruciform2Angle.ui"))


class AddCruciform2AngleUi(base, form):
    ...
    def clicker_create_profile(self):
        ...
        exist_flag = create_2l_cruciform(h, b, tw, tfl, dist, self.pathFolder, profile_name)
        if exist_flag:
            msg = QMessageBox()
