...
from computation_core.cross_sections import create_Isection


form, base = uic.loadUiType(resolve_path("section_properties_ui/Isection.ui"))


class AddIsectionUi(base, form):
    ...
    def clicker_create_profile(self):
        ...
        exist_flag = create_Isection(h, b, tw, tfl, self.pathFolder, profile_name)
        if exist_flag:
            msg = QMessageBox()
