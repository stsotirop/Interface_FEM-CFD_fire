...
from computation_core.cross_sections import create_4l


form, base = uic.loadUiType(resolve_path("section_properties_ui/Cruciform4Angle.ui"))


class AddCruciform4AngleUi(base, form):
    ...
    def clicker_create_profile(self):
        ...
        exist_flag = create_4l(h, b, tw, tfl, dist, self.pathFolder, profile_name)
        if exist_flag:
            msg = QMessageBox()
