...
from computation_core.cross_sections import create_upn


form, base = uic.loadUiType(resolve_path("section_properties_ui/Channel.ui"))


class AddChannelUi(base, form):
    ...
    def clicker_create_profile(self):
        ...
        exist_flag = create_upn(h, b, tw, tfl, self.pathFolder, profile_name)
        if exist_flag:
            msg = QMessageBox()
