...
from computation_core.cross_sections import create_l


form, base = uic.loadUiType(resolve_path("section_properties_ui/Angle.ui"))


class AddAngleUi(base, form):
    ...
    def clicker_create_profile(self):
        ...
        exist_flag = create_l(h, b, tw, tfl, self.pathFolder, profile_name)
        if exist_flag:
            msg = QMessageBox()
