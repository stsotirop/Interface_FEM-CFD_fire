...
from computation_core.cross_sections import create_2l


form, base = uic.loadUiType(resolve_path("section_properties_ui/DoubleAngle.ui"))


class AddDoubleAngleUi(base, form):
    ...
    def clicker_create_profile(self):
        ...
        exist_flag = create_2l(h, b, tw, tfl, dist, self.pathFolder, profile_name)
        if exist_flag:
            msg = QMessageBox()
