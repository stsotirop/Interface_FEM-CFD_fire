...
from computation_core.cross_sections import create_tee


form, base = uic.loadUiType(resolve_path("section_properties_ui/Tee.ui"))


class AddTeeUi(base, form):
    ...
    def clicker_create_profile(self):
        ...
        exist_flag = create_tee(h, b, tw, tfl, self.pathFolder, profile_name)
        if exist_flag:
            msg = QMessageBox()
